...
ALTER TABLE [dbo].[ScorePoints]
    ADD CONSTRAINT [FK_SwimClub_ScorePoints] FOREIGN KEY ([SwimClubID]) REFERENCES [dbo].[SwimClub] ([SwimClubID]) ON DELETE CASCADE;
GO
...
ALTER TABLE [dbo].[ScorePoints]
    ADD CONSTRAINT [PK_ScorePoints] PRIMARY KEY CLUSTERED ([ScorePointsID] ASC);
GO
