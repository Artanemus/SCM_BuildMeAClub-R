...
ALTER TABLE [dbo].[TeamSplit]
    ADD CONSTRAINT [FK_TeamEntrant_TeamSplit] FOREIGN KEY ([TeamEntrantID]) REFERENCES [dbo].[TeamEntrant] ([TeamEntrantID]) ON DELETE CASCADE;
GO
...
ALTER TABLE [dbo].[TeamSplit]
    ADD CONSTRAINT [PK_TeamSplit] PRIMARY KEY NONCLUSTERED ([TeamSplitID] ASC);
GO
