...
ALTER TABLE [dbo].[Qualify]
    ADD CONSTRAINT [FK_Stroke_Qualify] FOREIGN KEY ([StrokeID]) REFERENCES [dbo].[Stroke] ([StrokeID]) ON DELETE SET NULL;
GO

ALTER TABLE [dbo].[Qualify]
    ADD CONSTRAINT [FK_Distance_Quali4] FOREIGN KEY ([QualifyDistID]) REFERENCES [dbo].[Distance] ([DistanceID]);
GO

ALTER TABLE [dbo].[Qualify]
    ADD CONSTRAINT [FK_Gender_Qualify] FOREIGN KEY ([GenderID]) REFERENCES [dbo].[Gender] ([GenderID]) ON DELETE SET NULL;
GO

ALTER TABLE [dbo].[Qualify]
    ADD CONSTRAINT [FK_Distance_Qualify] FOREIGN KEY ([TrialDistID]) REFERENCES [dbo].[Distance] ([DistanceID]) ON DELETE SET NULL;
GO

ALTER TABLE [dbo].[Qualify]
    ADD CONSTRAINT [PK_Qualify] PRIMARY KEY CLUSTERED ([QualifyID] ASC);
GO
